...
train_data, test_data, train_labels, test_labels = train_test_split(encoded_reviews, labels, test_size=0.2,
                                                                    random_state=42)
...
def chatbot():
    ...
    while True:
        ...
        tokens_tensor = torch.tensor(tokens).unsqueeze(0).to(device)  # Add batch dimension and send to device
